    ...
    <>
      ...
      <section className="container mx-auto scroll-smooth">
        <div className="flex flex-col w-full gap-8 px-6 py-6 lg:flex-row ">
          <div
            data-aos="zoom-in"
            className="flex flex-col items-center lg:max-h-[40rem] justify-center p-4 bg-white/75 rounded-lg shadow-md lg:top-[6rem] lg:w-[30%] lg:left-20 lg:sticky w-fit"
          >
            <div className="w-full p-8 mb-2 bg-white rounded-lg shadow-md">
              <img
                src={profile}
                className="w-full px-2 pt-2 rounded-lg bg-gradient-to-br from-green-200 via-green-400 to-green-600 drop-shadow-lg"
                alt=""
              />
            </div>
            ...
            <div className="flex flex-row items-center justify-center gap-6 mt-6 text-green-600">
              <a
                href="https://www.github.com/muhammadrinaldi7/"
                target="_blank"
              >
                <FontAwesomeIcon
                  icon={faGithub}
                  className="w-6 h-6 p-2 bg-gray-100 rounded-full"
                />
              </a>
              <a
            ...
            <div className="flex flex-col items-center justify-center w-full">
              <button className="w-full px-4 py-3 mt-6 font-medium text-white bg-green-600 rounded-xl">
                Contact Me
              </button>
            </div>
          </div>
          <div
            data-aos="fade-up"
            className="z-30 flex gap-8 mt-0 flex-col px-12 lg:min-h-[100vh] scroll-smooth lg:w-[70%]"
          >
            <div className="flex flex-col gap-4">
              <p className="text-xl font-medium text-left uppercase ">
                About Me
              </p>
              <p className="text-justify text-gray-600">
                Saya adalah lulusan Teknik Informatika dari Universitas Islam
                Kalimantan (UNISKA) Muhammad Arsyad Al Banjari, dengan
                pengalaman kerja di PT. Kapuas Kencana Jaya (KKJ) dan PT.
                Nansarunai Mega Vision di bidang IT. Saya juga memiliki
                pengalaman magang di CV. Nusantara Jaya Komputer dan PT. Gawi
                Makmur Kalimantan.
              </p>
              <p className="text-justify text-gray-600">
              ...
              <p className="text-justify text-gray-600">
                ...
                mendalam dalam bidang teknologi informasi. Mampu bekerja secara
                mandiri maupun dalam tim, saya adalah individu yang komunikatif
                dan berdedikasi tinggi dalam mencapai tujuan perusahaan. Saya
                siap memanfaatkan pengalaman serta keahlian teknis dan
                interpersonal yang saya miliki untuk memberikan kontribusi
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <ul className="ml-3 list-disc list-inside">
                  <li>
                    Menangani pengelolaan dan pemeliharaan sistem TI serta
                    memberikan dukungan teknis kepada pengguna.
                  </li>
                  <li>
                    Berpartisipasi dalam proyek pengembangan perangkat lunak,
                    termasuk analisis, pengujian, dan implementasi solusi
                    teknologi.
                  </li>
                  <li>
                    Mengelola tugas-tugas administratif dan teknis, termasuk
              ...
              >
                <ul className="ml-3 list-disc list-inside">
                  <li>
                    Menangani pengelolaan dan pemeliharaan sistem TI serta
                    memberikan dukungan teknis serta perangkat kepada pengguna.
                  </li>
                  <li>
                    Membuat laporan analisa penjualan perusahaan di semua cabang
                    lewat query SQL dengan SAP HanaSQL.
                  </li>
                  <li>
                    Menganalisa kesalahan transaksi user dan kerusakan
                    perangkat.
                  </li>
                  <li>
                    Memelihara dan maintanance server cloud dan lokal serta
                    seluruh perangkat secara berkala.
                  </li>
                </ul>
              </CardExpEdu>
              <CardExpEdu
              ...
              >
                <ul className="ml-3 list-disc list-inside">
                  <li>
                    Merekap database karyawan dan memfilter data berdasarkan
                    kategori.
                  </li>
                  <li>
                    Menganalisa dan membuat graf karyawan berdasarkan data.
                  </li>
                </ul>
              </CardExpEdu>
              <CardExpEdu
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <ul className="ml-3 list-disc list-inside">
                  <li>
                    Mengikuti beberapa program pelatihan praktikum basis
                    data,program paket niaga, pemrograman web dan pemrograman
                    android.
                  </li>
                  <li>
                    Mengikuti ujian lembaga sertifikasi profesi komputer dan
                    mendapatkan hasil kompeten dari BNSP.
                  </li>
                  <li>
                    Menguasai beberapa bahasa pemrograman PHP, Visual Basic,
                    VB.net, Java, dan SQL serta framework bootstrap dan
                    codeigniter 3.
                  </li>
                </ul>
              </CardExpEdu>
