    ...
    <>
      ...
      <section className="container mx-auto">
        <div className="flex flex-col justify-center gap-4 p-6 lg:flex-row">
          <div
            className="flex w-full lg:w-[30%] flex-col justify-center bg-white gap-3 p-4 rounded-xl"
            data-aos="zoom-in"
          >
          ...
          <div
            className="flex w-full lg:w-[70%] flex-col justify-center gap-3 rounded-xl"
            data-aos="fade-up"
          >
            <div className="flex h-[5%] items-center justify-center w-full gap-6 px-8 py-10 text-3xl font-medium text-center">
              <h1 className="text-4xl font-semibold text-green-500 lg:text-6xl">
                MY SKILLS
              </h1>
            </div>
            <div className="bg-white gap-8 overflow-auto rounded-xl p-6 h-[95%]">
              <div
                data-aos="zoom-in"
                className="grid items-center justify-center w-full grid-cols-2 gap-6 p-6 overflow-auto bg-gray-100 md:grid-cols-4 rounded-xl"
              >
                ...
                <CardSkill skill="Github">
                  <FontAwesomeIcon icon={faGithub} size="4x" />
                </CardSkill>
                <CardSkill skill="Github Actions(CI/CD)">
