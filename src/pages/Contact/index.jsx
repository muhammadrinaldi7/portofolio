  ...
  return (
    <>
      ...
      <section className="container px-6 py-8 mx-auto lg:px-10">
        <div
          className="flex flex-col justify-center w-full gap-5 lg:flex-row"
          data-aos="fade-down"
        >
          ...
          <div
            className="flex w-[100%] flex-col p-6 bg-white rounded-xl"
            data-aos="fade-down"
          >
            <h1 className="text-4xl font-medium">Let's Work Together</h1>
            {isSubmitted && (
              <div className="flex justify-between p-4 mt-4 text-green-500 bg-white drop-shadow-lg rounded-xl">
                {" "}
            ...
            <form ref={form} onSubmit={handleSubmit}>
              ...
              />
              <button
                className="w-full p-4 mt-4 text-white bg-black rounded-lg"
                type="submit"
              >
                Send
              </button>
